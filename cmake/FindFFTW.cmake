...
if(CUFFT)
    ...
    find_library(FFTWF_LIBRARIES  NAMES fftw3f  PATHS ${LIB_PATHFFT})  
    find_library(FFTW_LIBRARIES   NAMES fftw3   PATHS ${LIB_PATHFFT}) 
    list(APPEND FFTW_LIBRARIES ${FFTWF_LIBRARIES} )
    # PARALLELISM OPTIONS
