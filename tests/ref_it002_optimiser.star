# RELION optimiser
# --o test_output/out --i ap_s_c2d_red.star --particle_diameter 200 --angpix 1.0 --ref ref_model.mrc --ini_high 50 --ctf --ctf_corrected_ref --iter 2 --tau2_fudge 2 --K 1 --flatten_solvent --zero_mask --oversampling 1 --healpix_order 2 --offset_range 5 --offset_step 2 --sym C1 --norm --scale --j 1 --memory_per_thread 4 --random_seed 1993 --onthefly_shifts --scale 

data_optimiser_general

_rlnOutputRootName                                    test_output/out
_rlnModelStarFile                                     test_output/out_it002_model.star
_rlnExperimentalDataStarFile                          test_output/out_it002_data.star
_rlnOrientSamplingStarFile                            test_output/out_it002_sampling.star
_rlnCurrentIteration                                             2
_rlnNumberOfIterations                                           2
...
_rlnOverallAccuracyTranslations                           6.433333
_rlnChangesOptimalOrientations                        2.344467e-07
