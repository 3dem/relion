...
void MotionRefiner::usage()
{
	parser.writeUsage(std::cout);
}

void MotionRefiner::initialise()
{
...
void MotionRefiner::processSubsetMicrographs(long g_start, long g_end)
{
    int barstep;
...
void MotionRefiner::prepMicrograph(
...
std::vector<std::vector<d2Vector>> MotionRefiner::optimize(
...
void MotionRefiner::writeOutput(
        const std::vector<std::vector<d2Vector>>& tracks,
