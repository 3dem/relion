...
void RelionJob::initialiseSelectJob()
{
	...
	joboptions["do_rank_relative"] = JobOption("Use relative threshold for auto-selection? ", false, "If set to true, only classes with the value above times the maximum predicted score of the classes in the run will be selected.");
