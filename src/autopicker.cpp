...
if(do_gpu)
	...
	fn_bash = parser.getOption("--topaz_exe", "Name of bash executable", "/bin/bash");
	fn_conda_activate = parser.getOption("--activate_exe", "Name of conda activate executable", "/lmb/home/scheres/app/anaconda3/bin/activate");
