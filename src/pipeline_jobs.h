...
//static std::map<int, std::string> node_type2labelnew = {{NODE_MOVIES, LABEL_MOVIES_CPIPE},
//		{NODE_MICS, LABEL_MICS_CPIPE},
//		{NODE_MIC_COORDS, LABEL_COORDS_CPIPE},
//		{NODE_PART_DATA, LABEL_PARTS_CPIPE},
//		{NODE_REFS, LABEL_2DIMGS_CPIPE},
//		{NODE_3DREF, LABEL_MAP_CPIPE},
//		{NODE_MASK, LABEL_MASK_CPIPE},
//		{NODE_MODEL, LABEL_OPTIMISER_CPIPE}, // SHWS 27nov2019: no longer distinguish between MODEL and OPTIMISER nodes ... keep integer NODE for backwards compatibility
//		{NODE_OPTIMISER, LABEL_OPTIMISER_CPIPE},
//		{NODE_HALFMAP, LABEL_HALFMAP_CPIPE},
//		{NODE_FINALMAP, LABEL_MAP_CPIPE}, // SHWS 27nov2019: no longer distinguish between 3DREF and FINAL maps ... keep integer NODE for backwards compatibility
//		{NODE_RESMAP, LABEL_RESMAP_CPIPE},
//		{NODE_PDF_LOGFILE, LABEL_LOGFILE_CPIPE},
//		{NODE_POST, LABEL_POST},
//		{NODE_POLISH_PARAMS, LABEL_POLISH_PARAMS},
//		{NODE_TOMO_OPTIMISATION, LABEL_TOMO_OPTIMISATION},
//		{NODE_TOMO_TOMOGRAMS, LABEL_TOMO_TOMOGRAMS},
//		{NODE_TOMO_TRAJECTORIES, LABEL_TOMO_TRAJECTORIES},
//		{NODE_TOMO_MANIFOLDS, LABEL_TOMO_MANIFOLDS} };
...
//static std::map<std::string, int> node_labelnew2type = {{LABEL_MOVIES_CPIPE, NODE_MOVIES},
//		{LABEL_MICS_CPIPE, NODE_MICS},
//		{LABEL_COORDS_CPIPE, NODE_MIC_COORDS},
//		{LABEL_PARTS_CPIPE, NODE_PART_DATA},
//		{LABEL_2DIMGS_CPIPE, NODE_REFS},
//		{LABEL_MAP_CPIPE, NODE_3DREF},
//		{LABEL_MASK_CPIPE, NODE_MASK},
//		{LABEL_OPTIMISER_CPIPE, NODE_OPTIMISER},
//		{LABEL_HALFMAP_CPIPE, NODE_HALFMAP},
//		{LABEL_RESMAP_CPIPE, NODE_RESMAP},
//		{LABEL_LOGFILE_CPIPE, NODE_PDF_LOGFILE},
//		{LABEL_POST, NODE_POST},
//		{LABEL_POLISH_PARAMS, NODE_POLISH_PARAMS},
//		{LABEL_TOMO_OPTIMISATION, NODE_TOMO_OPTIMISATION},
//		{LABEL_TOMO_TOMOGRAMS,    NODE_TOMO_TOMOGRAMS},
//		{LABEL_TOMO_TRAJECTORIES, NODE_TOMO_TRAJECTORIES},
//		{LABEL_TOMO_MANIFOLDS,    NODE_TOMO_MANIFOLDS} };
