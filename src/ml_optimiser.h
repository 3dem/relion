...
public:
	...
	int TIMING_EXP_SETUP, TIMING_ITER_WRAPUP, TIMING_ITER_HELICALREFINE;
	int TIMING_ITER_SOLVFLAT, TIMING_ITER_UPDATERES, TIMING_ITER_WRITE, TIMING_ITER_LOCALSYM;
